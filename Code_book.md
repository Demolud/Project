...
The data processed by the run_analysis.R script come from Human Activity Recognition Using Smartphones Dataset Version 1.0
prepared by 
...
Data set contains results of the experiments that have been carried out with a group of **30 volunteers** 
...
Using its embedded accelerometer and gyroscope, authors captured 3-axial linear acceleration and 3-axial angular velocity
...
## Information about the source variables
...
Features are **normalized and bounded within [-1,1] - therefore variables have no units**.
...
That gives 30x6=180 observations and 79 variables describing mean and standart deviation of the signals plus additional 
grouping variable containing list of subject and another grouping variable containing list of activities. 
Therefore **final tidy data set has 180 observations and 81 variables**.
